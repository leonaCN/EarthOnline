...
namespace Medieval
{
    ...
    public class DynamicCharacter : MonoBehaviour
    {
        ...
        void Inputs()
        {
            ...
            HorizontalX = MedievalInput.GetAxis(MedievalInput.Axis.MoveHorizontal);
            VerticalY = MedievalInput.GetAxis(MedievalInput.Axis.MoveVertical);
            ...
            //Crouch
            if (MedievalInput.GetButtonDown(MedievalInput.Buttons.CrouchButton) && IsGrounded == true && IsRunning == false && IsDriving == false)
            {
                IsCrouched = !IsCrouched;
            }

            //XBOX 360 CROUCH 
            if (MedievalInput.GetButton(MedievalInput.Buttons.CrouchButton) && IsGrounded == true && IsRunning == false && IsDriving == false)
            {
                IsCrouched = true;
            }

            if (MedievalInput.GetButtonUp(MedievalInput.Buttons.CrouchButton) && IsGrounded == true && IsRunning == false && IsDriving == false)
            {
                IsCrouched = false;
            }
            ...
            //Jump
            if (MedievalInput.GetButtonDown(MedievalInput.Buttons.JumpButton) && IsGrounded == true && IsJumping == false && IsRolling == false && IsDriving == false)
            {
            ...
            //Roll
            if (MedievalInput.GetButtonDown(MedievalInput.Buttons.RollButton) && IsGrounded == true && IsRolling == false)
            {
                anim.SetTrigger("roll");
                Invoke("_disableroll", 1f);
            }
            //Running
            if (MedievalInput.GetButton(MedievalInput.Buttons.RunButton))
            {
                IsRunning = true;
                IsCrouched = false;
            }
            ...
            {
                if (MedievalInput.GetButtonDown(MedievalInput.Buttons.ShotButton) && IsRolling == false && IsDriving == false && IsArmed == false && WeaponInUse == null)
                {
                    PunchAttack();
                }
            }
            ...
            {
                //Aiming
                if (MedievalInput.GetButtonDown(MedievalInput.Buttons.AmingButton))
                {
                    IsAiming = !IsAiming;
                }
                ...
                {
                    if (MedievalInput.GetButton(MedievalInput.Buttons.ShotButton))
                    {
                ...
                else //Semi-Auto Shooting
                {
                    ...
                    if (MedievalInput.GetButtonDown(MedievalInput.Buttons.ShotButton) && IsRolling == false && IsDriving == false && WeightIK > 0.7f && WeaponInUse.BulletsAmounts > 0 && WeaponInUse.IsShooted == true && WeaponInUse.CurrentFireRateToShoot > 0.12f)
                    {
                        WeaponInUse.Shot();
                    }
                }
                ...
                //Reload
                if (MedievalInput.GetButtonDown(MedievalInput.Buttons.ReloadButton) && WeaponInUse.BulletsAmounts < WeaponInUse.BulletsPerMagazine && WeaponInUse.TotalBullets > 0 && IsReloading == false)
                {
                    anim.SetTrigger("reload");
                    IsReloading = true;
                }
                //Auto-Reload
                if (MedievalInput.GetButton(MedievalInput.Buttons.ShotButton) && WeaponInUse.BulletsAmounts == 0 && WeaponInUse.TotalBullets > 0 && IsReloading == false)
                {
                    anim.SetTrigger("reload");
                    IsReloading = true;
                }
            ...
            { //if IsDriving == true cant change weapons
                ...
                if (MedievalInput.GetButtonDown(MedievalInput.Buttons.NextWeaponButton))
                {
                    _NextWeapon();
                }
                if (MedievalInput.GetButtonDown(MedievalInput.Buttons.PreviousWeaponButton))
                {
                    _PreviousWeapon();
                }
            }
        ...
        void PickUpWeapons()
        {
            ...
            if (Physics.Raycast(MyCamera.transform.position, MyCamera.transform.forward, out hitweapon, MyPivotCamera.Distance + 1, WeaponLayer))
            {
                if (hitweapon.collider.gameObject.layer == 14)
                {
                    ...
                    if (MedievalInput.GetButtonDown(MedievalInput.Buttons.PickupButton))
                    {
                        if (Weapons.Length > 0)
                        {
        ...
        void DriveControl()
        {
            ...
            //Enter in car
            if (MedievalInput.GetButtonDown(MedievalInput.Buttons.EnterVehicleButton))
            {
                if (IsDriving == false)
                {
                    if (VehicleInArea != null)
