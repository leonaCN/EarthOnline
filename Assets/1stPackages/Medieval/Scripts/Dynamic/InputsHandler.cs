...
namespace Medieval
{
	[AddComponentMenu("Medieval/Input Handler")]
	public class InputsHandler : MonoBehaviour
	{
		...
		//Input Bools
		[HideInInspector]
		public bool PressedShooting, PressedAiming, PressedReload, PressedRun, PressedJump,
			 PressedCrouch, PressedRoll, PressedPickupWeapon, PressedEnterVehicle, PressedNextWeapon, PressedPreviousWeapon;

		[HideInInspector]
		public bool PressedShootingDown, PressedAimingDown, PressedReloadDown, PressedRunDown, PressedJumpDown,
		...
		[HideInInspector]
		public bool PressedShootingUp, PressedAimingUp, PressedReloadUp, PressedRunUp, PressedJumpUp,
	...
	public class MedievalInput
	{
		static InputsHandler InputButtons;
		static void GetInputInstance()
		{
			if (InputButtons != null) return;
			InputButtons = GameObject.FindObjectOfType<InputsHandler>();
		}
		public enum Axis { MoveHorizontal, MoveVertical, RotateHorizontal, RotateVertical }
		public enum Buttons
		{
			ShotButton, AmingButton, JumpButton, RunButton,
