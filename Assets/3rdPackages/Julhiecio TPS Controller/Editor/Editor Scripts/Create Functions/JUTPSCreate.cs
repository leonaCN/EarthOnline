...
public class JUTPSCreate
{
    ...
    {
        var gamemanagerprefab = AssetDatabase.LoadAssetAtPath<Object>("Assets/3rdPackages/Julhiecio TPS Controller/Prefabs/Game/GameManager.prefab");
    ...
    public static void CreateNewThirdPersonCharacter()
    {
        ...
        else
        {
            ...
            if (anim != null)
            {
                ...
                var JUTPSAnimator = AssetDatabase.LoadAssetAtPath<RuntimeAnimatorController>("Assets/3rdPackages/Julhiecio TPS Controller/Animations/Animator/AnimatorTPS Controller.controller");
                ...
                for (int i = 0; i < 4; i++)
                {
                    pl.GetComponent<ThirdPersonController>().FootstepAudioClips[0].AudioClips[i] =
                        AssetDatabase.LoadAssetAtPath<AudioClip>("Assets/3rdPackages/Julhiecio TPS Controller/Audio/Footstep/CC0 Sounds/Concrete/Footstep on Concrete 0" + (i+1) + ".ogg");
                }

                pl.GetComponent<ThirdPersonController>().FootstepAudioClips[1].SurfaceTag = "Stone";
                for (int i = 0; i < 4; i++)
                {
                    //Assets/3rdPackages/Julhiecio TPS Controller/Audio/Footstep/CC0 Sounds/Stones/Footsteps-on-stone01.ogg
                    pl.GetComponent<ThirdPersonController>().FootstepAudioClips[1].AudioClips[i] =
                        AssetDatabase.LoadAssetAtPath<AudioClip>("Assets/3rdPackages/Julhiecio TPS Controller/Audio/Footstep/CC0 Sounds/Stones/Footsteps-on-stone0" + (i+1) + ".ogg");
                }
                ...
                for (int i = 0; i < 4; i++)
                {
                    pl.GetComponent<ThirdPersonController>().FootstepAudioClips[2].AudioClips[i] =
                        AssetDatabase.LoadAssetAtPath<AudioClip>("Assets/3rdPackages/Julhiecio TPS Controller/Audio/Footstep/CC0 Sounds/Grass/Footsteps-on-grass0" + (i+1) + ".ogg");
                }
                ...
                for (int i = 0; i < 4; i++)
                {
                    pl.GetComponent<ThirdPersonController>().FootstepAudioClips[3].AudioClips[i] =
                        AssetDatabase.LoadAssetAtPath<AudioClip>("Assets/3rdPackages/Julhiecio TPS Controller/Audio/Footstep/CC0 Sounds/Tiles/Footstep-on-tiles0" + (i+1) + ".ogg");
                }
                /*
                pl.GetComponent<ThirdPersonController>().FootstepAudioClips[1] =
                    AssetDatabase.LoadAssetAtPath<AudioClip>("Assets/3rdPackages/Julhiecio TPS Controller/Audio/Footstep/Footstep on Concrete 02.ogg");
                pl.GetComponent<ThirdPersonController>().FootstepAudioClips[2] =
                    AssetDatabase.LoadAssetAtPath<AudioClip>("Assets/3rdPackages/Julhiecio TPS Controller/Audio/Footstep/Footstep on Concrete 03.ogg");
                pl.GetComponent<ThirdPersonController>().FootstepAudioClips[3] =
                    AssetDatabase.LoadAssetAtPath<AudioClip>("Assets/3rdPackages/Julhiecio TPS Controller/Audio/Footstep/Footstep on Concrete 04.ogg");
                */
