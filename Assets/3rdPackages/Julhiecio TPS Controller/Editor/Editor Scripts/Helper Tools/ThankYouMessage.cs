...
public class StartThankyouMessage
{
    ...
    {
        if (System.IO.File.Exists(Application.dataPath + "/3rdPackages/Julhiecio TPS Controller/Editor/DontShowThankYouMessage.jutps") == false)
        {
            ThankYouWindow.ShowWindow();
            System.IO.File.Create(Application.dataPath + "/3rdPackages/Julhiecio TPS Controller/Editor/DontShowThankYouMessage.jutps");
        }
    }
}
...
public class ThankYouWindow : EditorWindow
{
    ...
    {
        Application.OpenURL(Application.dataPath + "/3rdPackages/Julhiecio TPS Controller/Documentation JU TPS.pdf");
    }
    ...
    private void OnGUI()
    {
        if (Banner == null)
        {
            Banner = JUTPS.CustomEditorUtilities.GetImage("Assets/3rdPackages/Julhiecio TPS Controller/Textures/Editor/JU TPS BANNER.png");
        }
        if (Banner != null)
        {
